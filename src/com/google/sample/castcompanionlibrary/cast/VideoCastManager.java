...
public class VideoCastManager extends BaseCastManager implements OnMiniControllerChangedListener, OnFailedListener {
	...
	public static VideoCastManager getInstance(Context context) throws CastException {
		if (null == sInstance) {
			LOGE(TAG, "No VideoCastManager instance was built, you need to build one first " + "(called from Context: "
					+ context + ")");
			throw new CastException();
		}
	...
	protected void onUiVisibilityChanged(boolean visible) {
		...
		mHandler.sendEmptyMessageDelayed(visible ? START_NOTIF_WHAT : STOP_NOTIF_WHAT, NOTIF_DELAY_MS);
